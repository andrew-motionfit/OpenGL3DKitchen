...

{
	...
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 1.0f, 0.3f, 0.3f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 1.0f, 0.3f, 0.3f);
	...
	// Light 2 — blue
	m_pShaderManager->setVec3Value("lightSources[2].position", 1.0f, 1.3f, 5.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[3].diffuseColor", 0.1f, 0.1f, 1.0f);
	m_pShaderManager->setVec3Value("lightSources[3].specularColor", 0.3f, 0.3f, 1.0f);
...
void SceneManager::PrepareScene()
{
	...
	CreateGLTexture("textures/Floor Texture.jpg", "Floor");
	CreateGLTexture("textures/Granite Texture.jpg", "Counter Top");
	CreateGLTexture("texture/Plaster Wall.jpg", "Wall");
	CreateGLTexture("texture/Fridge.jpg", "Fridge");
	CreateGLTexture("textures/GreenTexture.jpg", "Seat");
	CreateGLTexture("textures/MetalTexture.jpg", "Stool");
	CreateGLTexture("textures/OrangeSkinTexture.jpg", "Orange");
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(20.0f, 20.0f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(40.0f, 20.0f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-30.0f, 20.0f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(20.0f, 20.0f, 20.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.0f, -10.0f);
	...
	scaleXYZ = glm::vec3(7.0f, 15.0f, 7.0f);
	...
	scaleXYZ = glm::vec3(5.0f, 5.0f, 15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-20.0f, 0.0f, 4.97f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 2.2f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 1.3f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 1.4f, 5.0f);
	...
	m_basicMeshes->DrawPlaneMesh();
	//******************************************************************
	scaleXYZ = glm::vec3(2.0f, 4.3f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 1.3f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 1.3f, 8.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 1.4f, 8.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, -3.0f, 8.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 1.3f, 8.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 1.4f, 8.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, -3.0f, 8.5f);
